...
export const CREATE_PIC = document.getElementById("create-pic-page");
export const LOGIN = document.getElementById("login-page");
export const SIGNUP = document.getElementById("signup-page");
export const ERROR_404 = document.getElementById("error-page");
...
export const CREATE_PIC_LINK = document.getElementById("create-pic-link");
